    ...
    <div class="mx-auto">
        ...
        <ul class="text-center font-medium">
            ...
            @auth
                <div></div>
                @else 
                <li class="py-2"><a href="contact-us.html">Login</a></li>
            <li class="py-2"><a href="contact-us.html">Sign up</a></li>
            @endauth
        </ul>
    </div>
</section>
...
<nav class="relative bg-red-500">
    <div class="mx-auto hidden h-12 w-full max-w-[1200px] items-center md:flex">
        <button id="desktopMenuBtn"
            ...
            <div class="flex justify-around" id="categoryDropdown">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <div id="categoriesDropdown"
                    class="hidden absolute top-full left-0 bg-white shadow-md rounded-md mt-2 py-1 w-full z-10">
                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Category 1</a>
                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Category 2</a>
                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Category 3</a>
                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Category 4</a>
                </div>
                <!-- /Categories Dropdown -->
            </div>
