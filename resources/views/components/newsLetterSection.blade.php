<div class="bg-white">
    <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:py-6 lg:px-8">
        <div class="rounded-lg bg-gray-700 px-6 py-6 md:py-12 md:px-12 lg:py-16 lg:px-16 xl:flex xl:items-center">
            <div class="xl:w-0 xl:flex-1">
                <h2 class="text-2xl font-bold tracking-tight text-white sm:text-3xl">Want product news and updates?</h2>
                <p class="mt-3 max-w-3xl text-lg leading-6 text-red-200">Sign up for our newsletter to stay up to
                    date.</p>
            </div>
